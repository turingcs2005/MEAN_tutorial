...
1. Visual Studio Code (VSC) and plugins
    - (Optional) Vim plugin for VSC: The Vim text editor has long been valued for improving coding efficiency. However, with the rise of AI, its advantage has diminished, as AI can handle repetitive and routine code editing far faster than Vim. For simple code editing, Vim can still be faster than waiting for AI to process a command.
...
3. Global npm packages
    ...
    <code><pre class="command-line">npm i -g @angular/cli typescript npm-check-updates</pre></code>
4. Git
