...
<pre class="command-line"><code>git push -u origin main</code></pre>
- pull from and push to a remote repo's branch (of the same name as your local branch)
<pre class="command-line"><code>git pull origin main</code></pre>
<pre class="command-line"><code>git push origin main</code></pre>
...
- ammend a commit (before pushing to remote)
<pre class="command-line"><code>git commit --amend -m 'xxxx'</code></pre>
